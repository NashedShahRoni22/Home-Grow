...
const HomePP = () => {
  return (
    <div className="my-10 py-10 container mx-auto">
      <h1 className="text-4xl font-semibold text-center mb-5">Our Production & <span className="text-[#71B002]">Processing</span></h1>
      <div className="flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2">
          <img src={productionImg} alt="" />
        </div>
        <div className="lg:w-1/2">
          <h2 className="text-3xl font-semibold my-2 text-[#71B002]">Production</h2>
          ...
          <h2 className="text-3xl font-semibold my-2 text-[#71B002]">Processing</h2>
          <p className="text-justify">
